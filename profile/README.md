...
| 7 | [The Throughput Basin Origin](https://github.com/Windstorm-Institute/throughput-basin-origin) | At 92M, on Markov synthetic data, achieved BPT tracks training-corpus token entropy. **Published with internal adversarial review.** | 🟡 [PDF](https://github.com/Windstorm-Institute/throughput-basin-origin/blob/main/paper/Paper7-Throughput-Basin-Origin-v1.2.pdf) — Zenodo pending [Paper 7.1](https://github.com/Windstorm-Institute/throughput-basin-origin/issues/1) | [Labs](https://github.com/Windstorm-Labs/agi-extensions) |
