...
| # | Paper | Key Finding | DOI | Code Mirror |
|---|-------|-------------|-----|-------------|
| 10 | [Phonon Extraction Bound (BEC Analog Gravity)](https://github.com/Windstorm-Institute/phonon-extraction-bound) | BEC analog gravity: η ≤ 1 − T/T<sub>res</sub> (Carnot) ⇒ predicted **20% efficiency suppression** at T/T<sub>res</sub> = 0.2; 5 QuTiP Lindblad consistency checks, 1 clean scope limit | [10.5281/zenodo.20014391](https://doi.org/10.5281/zenodo.20014391) | [Labs](https://github.com/Windstorm-Labs/phonon-extraction-bound) |
