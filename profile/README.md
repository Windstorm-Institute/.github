...
| 8 | [The Vision Basin](https://github.com/Windstorm-Institute/vision-basin) | Cross-modal throughput: language, vision, audio. 12 models, real LJ Speech. | Preprint | [Labs](https://github.com/Windstorm-Labs/vision-basin) |
| 9 | [The Hardware Basin](https://github.com/Windstorm-Institute/hardware-basin) | Quantization cliff is about level allocation, not bit count. NF4 vs symmetric. | Preprint | [Labs](https://github.com/Windstorm-Labs/hardware-basin) |
