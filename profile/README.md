...
| 7 | [The Throughput Basin Origin](https://github.com/Windstorm-Institute/throughput-basin-origin) | At 92M, on Markov synthetic data, achieved BPT tracks training-corpus token entropy. **Published with internal adversarial review.** | [10.5281/zenodo.19498583](https://doi.org/10.5281/zenodo.19498583) · [PDF](https://github.com/Windstorm-Institute/throughput-basin-origin/blob/main/paper/Paper7-Throughput-Basin-Origin-v1.2.pdf) | [Labs](https://github.com/Windstorm-Labs/throughput-basin-origin) |
